...
### CREATE 制御文 {#c40-i0147}
*分類: IEBDG*  ・  難易度: 中級

CREATE 制御文は、ユーティリティのIEBDGで確認する項目です。1 タイプのレコードをまとめて生成する宣言。QUANTITY= で生成件数、NAME= で参照 FD のリストを指定する
...
??? note "検証手順（1件）"
    **CREATE 制御文**
    ...
    - 検証目的: 出力整理の制御文について、CREATE 制御文は、ユーティリティの IEBDG で確認する項目です。1 タイプのレコードをまとめて生成する宣言。QUANTITY= で生成件数、NAME= で参照 FDに関わる状態・定義・メッセージを机上で照合する。
    - 前提条件: SDSFまたは関連TSO/コンソールを参照でき、OSKB010108の検証用出力を記録できる。
    ...
    **ステップ 3**
    ...
    ③ ステップ3 の IEF142I と OSKB010108 が画面・出力に表示されること
    - 検証状態: 机上
    - 出典: z / OS DFSMSdfp Utilities (z / OS 3.1)
...
END 制御文は、ユーティリティのIEBDGで機能名、見出し、または確認対象として参照する項目です。関連する操作、設定、表示結果のどこに関わるかを出典マニュアルの節で確認します。z を参照し、用語だけでなく対象機能と確認すべき状態を結び付けます
...
??? note "検証手順（1件）"
    **END 制御文**
    ...
    - 検証目的: 区切整理の制御文について、END 制御文は、ユーティリティの IEBDG で機能名、見出し、または確認対象として参照する項目です。関連する操作、設定、表示結果のどこに関わるかを出典マニュアルの節で確認しに関わる状態・定義・メッセージを机上で照合する。
    - 前提条件: SDSFまたは関連TSO/コンソールを参照でき、OSKB010110の検証用出力を記録できる。
    - セッション環境: SDSFでST OSKBUTILを実行し、IEF142Iを含む表示を確認する。
    ...
    **ステップ 3**
    ...
    ③ ステップ3 の IEF142I と OSKB010110 が画面・出力に表示されること
    - 検証状態: 机上
    - 出典: z / OS DFSMSdfp Utilities (z / OS 3.1)



### FD ACTION オペランド {#c40-i0149}
*分類: IEBDG*  ・  難易度: 中級

FD ACTION オペランドは、ユーティリティのIEBDGで機能名、見出し、または確認対象として参照する項目です。FD ACTION オペランドは、FX (固定)、RP (繰り返し)、TL (テーブル参照)、WV (波形) などレコード毎のフィールド変動方式
...
??? note "検証手順（1件）"
    **FD ACTION オペランド**
    ...
    - 検証目的: 探索整理のオペランドについて、FD ACTION オペランドは、ユーティリティの IEBDG で機能名、見出し、または確認対象として参照する項目です。FD ACTION オペランドは、FX (固定)、RPに関わる状態・定義・メッセージを机上で照合する。
    - 前提条件: SDSFまたは関連TSO/コンソールを参照でき、OSKB010106の検証用出力を記録できる。
    - セッション環境: SDSFでST OSKBUTILを実行し、IEF142Iを含む表示を確認する。
    ...
    **ステップ 3**
    ...
    ③ ステップ3 の IEF142I と OSKB010106 が画面・出力に表示されること
    - 検証状態: 机上
    - 出典: z / OS DFSMSdfp Utilities (z / OS 3.1)



### FD FORMAT オペランド {#c40-i0150}
*分類: IEBDG*  ・  難易度: 中級

FD FORMAT オペランドは、ユーティリティのIEBDGで機能名、見出し、または確認対象として参照する項目です。FD FORMAT オペランドは、AL (英字)、AN (英数字)、ZD (Zoned Decimal)、PD (Packed Decimal)、CO (定数)、RA (ランダム) などのフィールド種別
...
??? note "検証手順（1件）"
    **FD FORMAT オペランド**
    ...
    - 検証目的: 終端整理のオペランドについて、FD FORMAT オペランドは、ユーティリティの IEBDG で機能名、見出し、または確認対象として参照する項目です。FD FORMAT オペランドは、AL (英字)、ANに関わる状態・定義・メッセージを机上で照合する。
    - 前提条件: SDSFまたは関連TSO/コンソールを参照でき、OSKB010105の検証用出力を記録できる。
    - セッション環境: SDSFでST OSKBUTILを実行し、IEF142Iを含む表示を確認する。
    ...
    **ステップ 3**
    ...
    ③ ステップ3 の IEF142I と OSKB010105 が画面・出力に表示されること
    - 検証状態: 机上
    - 出典: z / OS DFSMSdfp Utilities (z / OS 3.1)



### FD INDEX オペランド {#c40-i0151}
*分類: IEBDG*  ・  難易度: 中級

FD INDEX オペランドは、ユーティリティのIEBDGで機能名、見出し、または確認対象として参照する項目です。関連する操作、設定、表示結果のどこに関わるかを出典マニュアルの節で確認します。z を参照し、用語だけでなく対象機能と確認すべき状態を結び付けます
...
??? note "検証手順（1件）"
    **FD INDEX オペランド**
    ...
    - 検証目的: 上書整理のオペランドについて、FD INDEX オペランドは、ユーティリティの IEBDG で機能名、見出し、または確認対象として参照する項目です。関連する操作、設定、表示結果のどこに関わるかを出典マニュアに関わる状態・定義・メッセージを机上で照合する。
    - 前提条件: SDSFまたは関連TSO/コンソールを参照でき、OSKB010107の検証用出力を記録できる。
    - セッション環境: SDSFでST OSKBUTILを実行し、IEF142Iを含む表示を確認する。
    ...
    **ステップ 3**
    ...
    ③ ステップ3 の IEF142I と OSKB010107 が画面・出力に表示されること
    - 検証状態: 机上
    - 出典: z / OS DFSMSdfp Utilities (z / OS 3.1)



### FD 制御文 (フィールド定義) {#c40-i0152}
*分類: IEBDG*  ・  難易度: 中級

FD 制御文 (フィールド定義)は、ユーティリティのIEBDGで確認する項目です。1 つのフィールドの位置・長さ・初期値・変動規則を定義する。NAME= でフィールド名を付け、CREATE 内で参照可能にする
...
??? note "検証手順（1件）"
    **FD 制御文 (フィールド定義)**
    ...
    - 検証目的: 置換整理の制御文 フィールド定義について、FD 制御文 (フィールド定義)は、ユーティリティの IEBDG で確認する項目です。1 つのフィールドの位置・長さ・初期値・変動規則を定義する。NAME= でフィールド名を付に関わる状態・定義・メッセージを机上で照合する。
    - 前提条件: SDSFまたは関連TSO/コンソールを参照でき、OSKB010104の検証用出力を記録できる。
    - セッション環境: SDSFでST OSKBUTILを実行し、IEF142Iを含む表示を確認する。
    ...
    **ステップ 3**
    ...
    ③ ステップ3 の IEF142I と OSKB010104 が画面・出力に表示されること
    - 検証状態: 机上
    - 出典: z / OS DFSMSdfp Utilities (z / OS 3.1)



### REPEAT 制御文 {#c40-i0153}
*分類: IEBDG*  ・  難易度: 中級

REPEAT 制御文は、ユーティリティのIEBDGで機能名、見出し、または確認対象として参照する項目です。関連する操作、設定、表示結果のどこに関わるかを出典マニュアルの節で確認します。z を参照し、用語だけでなく対象機能と確認すべき状態を結び付けます
...
??? note "検証手順（1件）"
    **REPEAT 制御文**
    ...
    - 検証目的: 条件整理の制御文について、REPEAT 制御文は、ユーティリティの IEBDG で機能名、見出し、または確認対象として参照する項目です。関連する操作、設定、表示結果のどこに関わるかを出典マニュアルの節でに関わる状態・定義・メッセージを机上で照合する。
    - 前提条件: SDSFまたは関連TSO/コンソールを参照でき、OSKB010109の検証用出力を記録できる。
    - セッション環境: SDSFでST OSKBUTILを実行し、IEF142Iを含む表示を確認する。
    ...
    **ステップ 3**
    ...
    ③ ステップ3 の IEF142I と OSKB010109 が画面・出力に表示されること
    - 検証状態: 机上
    - 出典: z / OS DFSMSdfp Utilities (z / OS 3.1)



### ユーティリティの基本機能 {#c40-i0154}
*分類: IEBDG*  ・  難易度: 初級

ユーティリティの基本機能は、ユーティリティのIEBDGで確認する項目です。テストデータを定義に従って自動生成するユーティリティ。FD / CREATE / REPEAT / END 制御文でレコード構造と件数を宣言する
...
### EDIT NOPRINT オペランド {#c40-i0155}
*分類: IEBEDIT*  ・  難易度: 中級

EDIT NOPRINT オペランドは、ユーティリティのIEBEDITで機能名、見出し、または確認対象として参照する項目です。関連する操作、設定、表示結果のどこに関わるかを出典マニュアルの節で確認します。z を参照し、用語だけでなく対象機能と確認すべき状態を結び付けます
...
??? note "検証手順（1件）"
    **EDIT NOPRINT オペランド**
    ...
    - 検証目的: 値域整理のオペランドについて、EDIT NOPRINT オペランドは、ユーティリティの IEBEDIT で機能名、見出し、または確認対象として参照する項目です。関連する操作、設定、表示結果のどこに関わるかをに関わる状態・定義・メッセージを机上で照合する。
    - 前提条件: SDSFまたは関連TSO/コンソールを参照でき、OSKB010116の検証用出力を記録できる。
    - セッション環境: SDSFでST OSKBUTILを実行し、IEF142Iを含む表示を確認する。
    ...
    **ステップ 3**
    ...
    ③ ステップ3 の IEF142I と OSKB010116 が画面・出力に表示されること
    - 検証状態: 机上
    - 出典: z / OS DFSMSdfp Utilities (z / OS 3.1)



### EDIT START オペランド {#c40-i0156}
*分類: IEBEDIT*  ・  難易度: 中級

EDIT START オペランドは、ユーティリティのIEBEDITで機能名、見出し、または確認対象として参照する項目です。関連する操作、設定、表示結果のどこに関わるかを出典マニュアルの節で確認します。z を参照し、用語だけでなく対象機能と確認すべき状態を結び付けます
...
??? note "検証手順（1件）"
    **EDIT START オペランド**
    ...
    - 検証目的: 順序整理のオペランドについて、EDIT START オペランドは、ユーティリティの IEBEDIT で機能名、見出し、または確認対象として参照する項目です。関連する操作、設定、表示結果のどこに関わるかを出典に関わる状態・定義・メッセージを机上で照合する。
    - 前提条件: SDSFまたは関連TSO/コンソールを参照でき、OSKB010115の検証用出力を記録できる。
    - セッション環境: SDSFでST OSKBUTILを実行し、IEF142Iを含む表示を確認する。
    ...
    **ステップ 3**
    ...
    ③ ステップ3 の IEF142I と OSKB010115 が画面・出力に表示されること
    - 検証状態: 机上
    - 出典: z / OS DFSMSdfp Utilities (z / OS 3.1)



### EDIT STEPNAME オペランド {#c40-i0157}
*分類: IEBEDIT*  ・  難易度: 中級

EDIT STEPNAME オペランドは、ユーティリティのIEBEDITで機能名、見出し、または確認対象として参照する項目です。関連する操作、設定、表示結果のどこに関わるかを出典マニュアルの節で確認します。z を参照し、用語だけでなく対象機能と確認すべき状態を結び付けます
...
??? note "検証手順（1件）"
    **EDIT STEPNAME オペランド**
    ...
    - 検証目的: 比較整理のオペランドについて、EDIT STEPNAME オペランドは、ユーティリティの IEBEDIT で機能名、見出し、または確認対象として参照する項目です。関連する操作、設定、表示結果のどこに関わるかに関わる状態・定義・メッセージを机上で照合する。
    - 前提条件: SDSFまたは関連TSO/コンソールを参照でき、OSKB010114の検証用出力を記録できる。
    - セッション環境: SDSFでST OSKBUTILを実行し、IEF142Iを含む表示を確認する。
    ...
    **ステップ 3**
    ...
    ③ ステップ3 の IEF142I と OSKB010114 が画面・出力に表示されること
    - 検証状態: 机上
    - 出典: z / OS DFSMSdfp Utilities (z / OS 3.1)



### EDIT TYPE=INCLUDE / EXCLUDE {#c40-i0158}
*分類: IEBEDIT*  ・  難易度: 中級

EDIT TYPE=INCLUDE / EXCLUDEは、ユーティリティのIEBEDITで機能名、見出し、または確認対象として参照する項目です。関連する操作、設定、表示結果のどこに関わるかを出典マニュアルの節で確認します。z を参照し、用語だけでなく対象機能と確認すべき状態を結び付けます

**出典:** z / OS DFSMSdfp Utilities (z / OS 3.1)

??? note "検証手順（1件）"
    **EDIT TYPE=INCLUDE ・ EXCLUDE**

    - 検証目的: 記録整理の・について、EDIT TYPE=INCLUDE / EXCLUDE は、ユーティリティの IEBEDIT で機能名、見出し、または確認対象として参照する項目です。関連する操作、設定、表示結果に関わる状態・定義・メッセージを机上で照合する。
    - 前提条件: SDSFまたは関連TSO/コンソールを参照でき、OSKB010113の検証用出力を記録できる。
    - セッション環境: SDSFでST OSKBUTILを実行し、IEF142Iを含む表示を確認する。
    ...
    **ステップ 3**
    ...
    ③ ステップ3 の IEF142I と OSKB010113 が画面・出力に表示されること
    - 検証状態: 机上
    - 出典: z / OS DFSMSdfp Utilities (z / OS 3.1)
...
EDIT 制御文は、ユーティリティのIEBEDITで機能名、見出し、または確認対象として参照する項目です。関連する操作、設定、表示結果のどこに関わるかを出典マニュアルの節で確認します。z を参照し、用語だけでなく対象機能と確認すべき状態を結び付けます
...
??? note "検証手順（1件）"
    **EDIT 制御文**
    ...
    - 検証目的: 優先整理の制御文について、EDIT 制御文は、ユーティリティの IEBEDIT で機能名、見出し、または確認対象として参照する項目です。関連する操作、設定、表示結果のどこに関わるかを出典マニュアルの節でに関わる状態・定義・メッセージを机上で照合する。
    - 前提条件: SDSFまたは関連TSO/コンソールを参照でき、OSKB010112の検証用出力を記録できる。
    - セッション環境: SDSFでST OSKBUTILを実行し、IEF142Iを含む表示を確認する。
    ...
    **ステップ 3**
    ...
    ③ ステップ3 の IEF142I と OSKB010112 が画面・出力に表示されること
    - 検証状態: 机上
    - 出典: z / OS DFSMSdfp Utilities (z / OS 3.1)



### ユーティリティの基本機能 {#c40-i0160}
*分類: IEBEDIT*  ・  難易度: 初級

ユーティリティの基本機能は、ユーティリティのIEBEDITで確認する項目です。JCL ストリームから特定のジョブ / ステップだけを抜き出して別 SYSOUT (例: INTRDR) に出力するユーティリティ。再実行 JCL の生成に使う
...
### DCB 不一致時の動作 {#c40-i0161}
*分類: IEBGENER*  ・  難易度: 中級

DCB 不一致時の動作は、ユーティリティのIEBGENERで確認する項目です。SYSUT1 と SYSUT2 で RECFM/LRECL が異なる場合、可能な範囲で IEBGENER が変換する (例: 固定長[...]可変長)。互換性が無い組合せでは異常終了する
...
??? note "検証手順（1件）"
    **DCB 不一致時の動作**
    ...
    - 検証目的: 復旧確認の不一致時の動作について、DCB 不一致時の動作は、ユーティリティの IEBGENER で確認する項目です。SYSUT1 と SYSUT2 で RECFM/LRECL が異なる場合、可能な範囲で IEBに関わる状態・定義・メッセージを机上で照合する。
    ...
    **ステップ 3**
    ...
    ③ ステップ3 の IEF142I と OSKB010018 が画面・出力に表示されること
    - 検証状態: 机上
    - 出典: z / OS DFSMSdfp Utilities (z / OS 3.1)



### GENERATE MAXFLDS オペランド {#c40-i0162}
*分類: IEBGENER*  ・  難易度: 中級

GENERATE MAXFLDS オペランドは、ユーティリティのIEBGENERで確認する項目です。後続 RECORD 制御文の FIELD パラメータ数の合計を申告する。実際の合計以上の値を指定する必要があり、不足すると編集が打ち切られる

**出典:** z / OS DFSMSdfp Utilities (z / OS 3.1)

??? note "検証手順（1件）"
    **GENERATE MAXFLDS オペランド**

    - 検証目的: 出力確認のオペランドについて、GENERATE MAXFLDS オペランドは、ユーティリティの IEBGENER で確認する項目です。後続 RECORD 制御文の FIELD パラメータ数の合計を申告する。に関わる状態・定義・メッセージを机上で照合する。
    ...
    **ステップ 3**
    ...
    ③ ステップ3 の IEF142I と OSKB010008 が画面・出力に表示されること
    - 検証状態: 机上
    - 出典: z / OS DFSMSdfp Utilities (z / OS 3.1)
